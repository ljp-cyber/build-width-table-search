...
import com.shxex.bwts.kafka.MaxwellProcessor;
 ...
 */
@Slf4j
public class BizConsumerListener {

    @Autowired
    private ApplicationContext applicationContext;

    private MaxwellProcessor maxwellProcessor = new MaxwellProcessor();
    ...
    private void maxwellProcess(Maxwell maxwell) {
        maxwellProcessor.process(maxwell);
